...
if ('/Users/lefteriskavadasoffice/Documents/Aptana Studio 3 Workspace/Composer Dependencies for K2v3/vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Users/lefteriskavadasoffice/Documents/Aptana Studio 3 Workspace/Composer Dependencies for K2v3/vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
