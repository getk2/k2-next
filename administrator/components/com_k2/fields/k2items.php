		...
		if ($this->multiple)
		{
			...
			function K2SelectRow(row) {
				...
				if(!itemAlreadyInList){
					var li = '<li><a class=\"k2FieldResourceRemove\"><i class=\"icon icon-cancel\"></i></a><span class=\"k2FieldResourceMultipleHandle\">' + row.get('title') + '</span><input type=\"hidden\" value=\"' + row.get('id') + '\" name=\"".$this->name."[]\"/></li>';
