...
<div>
	...
	<div class="itemHeader">
	  ...
	  <?php if($this->params->get('tagItemTitle')): ?>
	  <!-- Item title -->
	  <h2 class="itemTitle">
	  	...
	  	<?php if($this->params->get('tagItemFeaturedNotice') && $this->item->featured): ?>
	  	<!-- Featured flag -->
	  	<span>
		  	<sup>
	  ...
	  <?php endif; ?>
		...
		<?php if($this->params->get('tagItemAuthor')): ?>
		<!-- Item Author -->
  ...
  <div class="itemBody">
	  ...
	  <?php if($this->params->get('tagItemImage') && $this->item->image): ?>
	  ...
	  <div class="itemImageBlock">
		  ...
		  <?php if($this->params->get('tagItemImageMainCaption') && $this->item->image->caption): ?>
		  <!-- Image caption -->
		  <span class="itemImageCaption"><?php echo $this->item->image->caption; ?></span>
		  <?php endif; ?>

		  <?php if($this->params->get('tagItemImageMainCredits') && $this->item->image->credits): ?>
		  <!-- Image credits -->
	  ...
	  <?php if($this->params->get('tagItemIntroText')): ?>
	  <!-- Item introtext -->
	  <div class="itemIntroText">
	  	<?php echo $this->item->introtext; ?>
	  </div>
	  <?php endif; ?>
	  <?php if($this->params->get('tagItemFullText')): ?>
	  <!-- Item fulltext -->
	  ...
	  <?php if($this->params->get('tagItemExtraFields') && count($this->item->extraFieldsGroups)): ?>
	  <!-- Item extra fields -->
	  ...
	  <?php endif; ?>
		...
		<?php if($this->params->get('tagItemHits') || ($this->params->get('tagItemDateModified') && intval($this->item->modified)!=0)): ?>
		<div class="itemContentFooter">

			<?php if($this->params->get('tagItemHits')): ?>
			<!-- Item Hits -->
			<span class="itemHits">
			...
			<?php if($this->params->get('tagItemDateModified') && intval($this->item->modified)!=0): ?>
			<!-- Item date modified -->
  ...
  <?php if($this->params->get('tagItemCategory') || $this->params->get('tagItemTags') || $this->params->get('tagItemAttachments')): ?>
  <div class="itemLinks">

		<?php if($this->params->get('tagItemCategory')): ?>
		<!-- Item category -->
	  ...
	  <?php if($this->params->get('tagItemTags') && count($this->item->tags)): ?>
	  <!-- Item tags -->
	  ...
	  <?php if($this->params->get('tagItemAttachments') && count($this->item->attachments)): ?>
	  <!-- Item attachments -->
	  <div class="itemAttachmentsBlock">
		  ...
		  <ul class="itemAttachments">
		    ...
		    <li>
			    ...
			    <?php if($this->params->get('tagItemAttachmentsCounter')): ?>
  ...
  <?php if($this->params->get('tagItemAuthorBlock') && empty($this->item->created_by_alias)): ?>
  <!-- Author Block -->
  <div class="itemAuthorBlock">

  	<?php if($this->params->get('tagItemAuthorImage') && $this->item->author->image): ?>
    ...
    <div class="itemAuthorDetails">
      ...
      <?php if($this->params->get('tagItemAuthorDescription') && !empty($this->item->author->description)): ?>
      <p><?php echo $this->item->author->description; ?></p>
      <?php endif; ?>

      <?php if($this->params->get('tagItemAuthorURL') && !empty($this->item->author->site)): ?>
      ...
      <?php if($this->params->get('tagItemAuthorEmail')): ?>
  ...
  <?php if($this->params->get('tagItemAuthorLatest') && count($this->item->author->latest)): ?>
  ...
  <?php if($this->params->get('tagItemRelated') && count($this->item->related)): ?>
	...
	<div class="itemRelated">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				...
				<?php if($this->params->get('tagItemRelatedTitle', 1)): ?>
				<a class="itemRelTitle" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
				<?php endif; ?>

				<?php if($this->params->get('tagItemRelatedCategory')): ?>
				<div class="itemRelCat"><?php echo JText::_("K2_IN"); ?> <a href="<?php echo $item->category->link ?>"><?php echo $item->category->title; ?></a></div>
				<?php endif; ?>

				<?php if($this->params->get('tagItemRelatedAuthor')): ?>
				...
				<?php if($this->params->get('tagItemRelatedImageSize') && $item->image): ?>
				...
				<?php if($this->params->get('tagItemRelatedIntrotext')): ?>
				<div class="itemRelIntrotext"><?php echo $item->introtext; ?></div>
				<?php endif; ?>

				<?php if($this->params->get('tagItemRelatedFulltext')): ?>
				<div class="itemRelFulltext"><?php echo $item->fulltext; ?></div>
				<?php endif; ?>

				<?php if($this->params->get('tagItemRelatedMedia') && count($item->media)): ?>
				...
				<?php if($this->params->get('tagItemRelatedImageGallery') && count($item->galleries)): ?>
