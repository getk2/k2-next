...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
 ...
 <?php if($this->params->get('catItemMedia') && count($this->item->media)): ?>
  <!-- Item video -->
  <div class="catItemVideoBlock">
	...
	<div class="itemMedia">
		...
		<div class="itemMediaOutput"><?php echo $entry->output; ?></div>
  ...
  <div class="clr"></div>
   ...
   <?php if($this->params->get('catItemGalleries') && count($this->item->galleries)): ?>
