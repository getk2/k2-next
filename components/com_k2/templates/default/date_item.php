...
<div>
  ...
  <div class="itemBody">
	  ...
	  <?php if($this->params->get('tagItemExtraFields') && count($this->item->extraFields)): ?>
	  <!-- Item extra fields -->
  ...
  <?php if($this->params->get('tagItemAuthorLatest') && !empty($this->item->author->latest)): ?>
  ...
  <?php if($this->params->get('tagItemRelated') && !empty($this->item->related)): ?>
	...
	<div class="itemRelated">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				...
				<?php if($this->params->get('tagItemRelatedMedia') && !empty($item->media)): ?>
				...
				<?php if($this->params->get('tagItemRelatedImageGallery') && !empty($item->galleries)): ?>
