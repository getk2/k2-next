	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login">
	  ...
	  <fieldset class="input">
	    ...
	    <p id="form-login-password">
	      ...
	      <input id="modlgn_passwd" type="password" name="<?php echo $login->passwordFieldName; ?>" class="inputbox" size="18" />
	    </p>
	  ...
	  <ul>
	    <li><a href="<?php echo $login->resetLink; ?>"><?php echo JText::_('K2_FORGOT_YOUR_PASSWORD'); ?></a></li>
	    <li><a href="<?php echo $login->remindLink ?>"><?php echo JText::_('K2_FORGOT_YOUR_USERNAME'); ?></a></li>
	    <?php if ($login->allowRegistration): ?>
	    <li><a href="<?php echo $login->registrationLink; ?>"><?php echo JText::_('K2_CREATE_AN_ACCOUNT'); ?></a></li>
	    <?php endif; ?>
	  </ul>
	  ...
	  <input type="hidden" name="return" value="<?php echo $login->return; ?>" />
